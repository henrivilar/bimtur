...
export default function Navbar() {
  ...
  const linksStyle = 'px-[30px] py-[28px] border-b-4 border-b-primary-orange hover:border-b-4 hover:text-primary-purple hover:border-b-primary-purple transition-all md:py-[19px]';
  const hoverScale = 'scale-100 hover:scale-114 transition-all duration-200';

  return (
    <nav className='fixed top-0 left-0 w-full z-50 bg-background shadow-md'>
      <div className='flex justify-between items-center py-6 max-w-360 mx-auto px-6 md:h-16 md:px-12 xl:px-36'>
        <img src={Logo} alt="Logo" className='w-20 md:w-16' />
